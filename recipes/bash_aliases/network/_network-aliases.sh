...
alias iptables-list-rules='_echo_info "sudo iptables -S\n"; sudo iptables -S; _echo_info "sudo iptables -L\n"; sudo iptables -L' ## list iptables rules
...
alias start-fail2ban='sudo systemctl start fail2ban'    ## Start fail2ban service
alias stop-fail2ban='sudo systemctl stop fail2ban'      ## Stop fail2ban service

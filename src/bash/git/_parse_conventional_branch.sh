...
## Parse conventional git branch (type, ticket, subject)
##
## {
##   "namespace": "git",
##   "summary": "Functions for parsing conventional git branch names including type, ticket, and subject components.",
##   "requires": [
##     "git",
##     "sed",
##     "command"

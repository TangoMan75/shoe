...
## Select a branch interactively from a list of git branches
##
## {
##   "namespace": "git",
##   "summary": "Select a branch interactively from a list of git branches.",
##   "requires": [
##     "git",
##     "command",
##     "sed",
...
##       "name": "arguments",
##       "type": "str",
##       "description": "Optional flags (-F: file type filter, -a: list all, -m: list main, -c: list current, -v: verbose, -h: help)",
##       "default": null,
##       "nullable": true
##     }
##   ]

...
## Select a commit interactively from a list of git commits
##
## {
##   "namespace": "git",
##   "summary": "Select a commit interactively from a list of git commits.",
##   "requires": [
##     "git",
##     "command",
##     "cut"
...
##       "name": "arguments",
##       "type": "str",
##       "description": "Branch name and optional flags (-n: count, -v: verbose, -h: help)",
##       "default": null,
##       "nullable": true
##     }
##   ]

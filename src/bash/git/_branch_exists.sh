...
## Check if a git branch exists in the local or remote repository
##
## {
##   "namespace": "git",
##   "summary": "Check if a git branch exists in the local or remote repository.",
##   "requires": [
##     "git",
##     "command"
##   ],
...
##       "name": "arguments",
##       "type": "str",
##       "description": "Branch name and optional flags (-a: list all, -r: remotes only, -v: verbose, -h: help)",
##       "default": null,
##       "nullable": false
##     }
##   ]

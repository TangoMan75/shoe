...
test_unknown_command_should_fail_with_expected_error_message() {
    assert_equals "error: \"foobar\" is not a valid command" "$(_remove_colors "$(${src_file} foobar)")"
}
...
test_unknown_flag_should_fail_with_expected_error_message() {
    assert_equals "error: \"--foobar\" is not a valid parameter" "$(_remove_colors "$(${src_file} --foobar)")"
}
...
test_unknown_short_flag_should_fail_with_expected_error_message() {
    assert_equals "error: \"-z\" is not a valid parameter" "$(_remove_colors "$(${src_file} -z)")"
}
...
test_unknown_option_should_fail_with_expected_error_message() {
    assert_equals "error: \"--foobar\" is not a valid parameter" "$(_remove_colors "$(${src_file} --foobar "foobar")")"
}
...
test_unknown_short_option_should_fail() {
    assert_fails "$(${src_file} -z "foobar")"
}

test_unknown_short_option_should_fail_with_expected_error_message() {
    assert_equals "error: \"-z\" is not a valid parameter" "$(_remove_colors "$(${src_file} -z "foobar")")"
}

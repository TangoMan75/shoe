...
Also it's not always readily available on all _Linux_ distributions, especially minimal ones from _Docker_ containers like _Alpine_ or _Busybox_.
...
6. **⚡ Automatic Boolean Variable-to-Flag Conversion:**
...
**TangoMan Shoe Shell Microframework** is 100% POSIX compliant, run your scripts in virtually any environment, including containers.
...
13. **⚡ Markdown Documentation Generator:**
...
15. **⚡ Shoemaker Developement Tool:**
...
- [./doc/shoe-xxs.md](./doc/shoe-xxs.md)
- [./doc/shoe-xs.md](./doc/shoe-xs.md)
- [./doc/shoe-sm.md](./doc/shoe-sm.md)
- [./doc/shoe-md.md](./doc/shoe-md.md)
- [./doc/shoe-xl.md](./doc/shoe-xl.md)

### 📝 Documentation for `shoemaker.sh` `entrypoint.sh` can be found here:
...
**TangoMan Shoe Shell Microframework** is available in three versions: extra small, small, medium, large, and extra large. Each one is optimized for best performance.

#### 🌈 Small Version

_shoe-sm.sh_ is the same as medium version without flags.

...
3. [Example documentation for light version can be found here: ./doc/shoe-light.md](./doc/shoe-light.md)
4. [Documentation for `entrypoint.sh` can be found here: ./doc/entrypoint.md](./doc/entrypoint.md)
...
### 🐛 Limitations of `awk` Regular Expressions

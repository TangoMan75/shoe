...
.PHONY: help hello flag_test self_install self_uninstall self_update generate_doc
##################################################
# Colors
##################################################
...
hello:
	@printf "${INFO}sh shoe-md.sh hello${EOL}"
	@sh shoe-md.sh hello

## Prints flag status
flag_test:
	@printf "${INFO}sh shoe-md.sh flag_test${EOL}"
	@sh shoe-md.sh flag_test
...
self_install:
	@printf "${INFO}sh shoe-md.sh self_install${EOL}"
	@sh shoe-md.sh self_install

## Uninstall script from system
self_uninstall:
	@printf "${INFO}sh shoe-md.sh self_uninstall${EOL}"
	@sh shoe-md.sh self_uninstall

## Update script from @update-link
self_update:
	@printf "${INFO}sh shoe-md.sh self_update${EOL}"
	@sh shoe-md.sh self_update
...
generate_doc:
	@printf "${INFO}sh shoe-md.sh generate_doc${EOL}"
	@sh shoe-md.sh generate_doc

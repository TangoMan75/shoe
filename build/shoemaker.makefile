...
## Print this help
help:
	$(call alert_primary, "TangoMan Shoe Maker")

	@printf "${WARNING}Description:${EOL}"
	@printf "${PRIMARY}  A versatile developement tool to split a script file into its components build a shoe script from "build.lst" file or generate markdown documentation from a shoe script.    $(_get_docbloc_title "$1")  $(_get_docbloc_description "$1")   ${EOL}\n"

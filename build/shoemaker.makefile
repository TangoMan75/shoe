...
help:
	...
	@printf "${PRIMARY}  A versatile developement tool to split a script file into its components build a script from build.lst file, generate Makefile or markdown documentation from a shoe script.  ${EOL}\n"

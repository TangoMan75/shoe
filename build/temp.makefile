...
.PHONY: help test path self_install self_uninstall
##################################################
# Colors
##################################################
...
## Execute test
test:
	@printf "${INFO}sh temp.sh test${EOL}"
	@sh temp.sh test

## Print pathes
path:
	@printf "${INFO}sh temp.sh path${EOL}"
	@sh temp.sh path
...
self_install:
	@printf "${INFO}sh temp.sh self_install${EOL}"
	@sh temp.sh self_install

## Uninstall script from system
self_uninstall:
	@printf "${INFO}sh temp.sh self_uninstall${EOL}"
	@sh temp.sh self_uninstall
